...
{
    public partial class _001_AllModelInitialization : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpericenceCenterName = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CallerRemarks = table.Column<string>(nullable: true),
                    LeadClassificationId = table.Column<int>(nullable: true),
                    LeadStatusId = table.Column<int>(nullable: true),
                    QuantityInSquareFeet = table.Column<int>(nullable: false),
                    ...
                    VolumeInSqureFeet = table.Column<int>(nullable: false),
