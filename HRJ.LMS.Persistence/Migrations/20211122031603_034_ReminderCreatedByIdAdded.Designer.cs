...
namespace HRJ.LMS.Persistence.Migrations
{
    ...
    [Migration("20211122031603_034_ReminderCreatedByIdAdded")]
    partial class _034_ReminderCreatedByIdAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRJ.LMS.Domain.ExcludeLead", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HRJ.LMS.Domain.ExperienceCenter", b =>
                {
                    ...
                    b.Property<string>("ExperienceCenterShortName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HRJ.LMS.Domain.FiscalMonth", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("EndMonthDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("FiscalMonthLabel")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FiscalYearDuration")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("FiscalYearId")
                        .HasColumnType("int");

                    b.Property<DateTime>("StartMonthDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("HRJ.LMS.Domain.FiscalYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("EndYearDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime>("StartYearDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("HRJ.LMS.Domain.JustDialLead", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("DNCMobile")
                        .HasColumnType("int");

                    b.Property<int>("DNCPhone")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRJ.LMS.Domain.Lead", b =>
                {
                    ...
                    b.Property<DateTime?>("AssignedAtToEC")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<decimal?>("LeadValueINR")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("QuantityInSquareFeet")
                    ...
                    b.Property<decimal?>("VolumeInSquareFeet")
                        .HasColumnType("decimal(18,3)");
            ...
            modelBuilder.Entity("HRJ.LMS.Domain.LeadActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ActivityHeading")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("LeadActivityRemarks")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HRJ.LMS.Domain.LeadInvoiceFileDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LeadInvoiceFileDetails");
                });
            ...
            modelBuilder.Entity("HRJ.LMS.Domain.StateCityMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HRJ.LMS.Domain.WebLead", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRJ.LMS.Domain.FiscalMonth", b =>
                {
                    b.HasOne("HRJ.LMS.Domain.FiscalYear", "FiscalYear")
                        .WithMany("FiscalMonths")
            ...
            modelBuilder.Entity("HRJ.LMS.Domain.LeadInvoiceFileDetail", b =>
                {
                    b.HasOne("HRJ.LMS.Domain.Lead", "Lead")
                        .WithMany("LeadInvoiceFileDetails")
                        .HasForeignKey("LeadId");

                    b.HasOne("HRJ.LMS.Domain.AppUser", "RemovedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("HRJ.LMS.Domain.LeadReminder", b =>
                {
                    b.HasOne("HRJ.LMS.Domain.AppUser", "CreatedBy")
                        .WithMany()
